...
variable "google_organization_id" {
  description = "The ID of the organization - needed to define service account generated by Google for use by the PAM service which has the format 'serviceAccount:service-org-${var.google_organization_id}@gcp-sa-pam.iam.gserviceaccount.com'."
  type        = string
  default     = ""
}