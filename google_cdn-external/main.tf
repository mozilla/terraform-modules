...
resource "google_compute_backend_service" "default" {
  ...
  dynamic "cdn_policy" {
    ...
    content {
      ...
      cache_key_policy {
        include_host         = lookup(var.cdn_cache_key_policy, "include_host", true)
        include_protocol     = lookup(var.cdn_cache_key_policy, "include_protocol", true)
        include_query_string = lookup(var.cdn_cache_key_policy, "include_query_string", true)
      }
    }
  }
