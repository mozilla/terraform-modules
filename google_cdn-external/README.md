...
| <a name="input_custom_request_headers"></a> [custom\_request\_headers](#input\_custom\_request\_headers) | Specifies custom response headers | `list(string)` | `null` | no |
| <a name="input_custom_response_headers"></a> [custom\_response\_headers](#input\_custom\_response\_headers) | Specifies custom response headers | `list(string)` | `null` | no |
